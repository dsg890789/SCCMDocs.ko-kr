...
이 정보는 Configuration Manager 기술 미리 보기 분기의 모든 버전에 적용됩니다. 이 문서에서는 먼저 나타나는 기술 미리 보기 버전과 함께 각 새로운 기능을 나열합니다. 예를 들어 2020년(`20`) 1월(`01`)에 대한 버전 **2001**입니다. 각 미리 보기 버전에 전용으로 제공되는 개별 문서에서 개별 기능을 자세히 설명합니다.
...
### <a name="technical-preview-version-2001"></a>기술 미리 보기 버전 2001

<!-- - [title](/sccm/core/get-started/2020/technical-preview-2001#bkmk_anchor) <!--ID-->

- [Microsoft Edge 관리 대시보드](/sccm/core/get-started/2020/technical-preview-2001#bkmk_edge-dash) <!--3871913-->
- [오케스트레이션 그룹의 향상된 기능](/sccm/core/get-started/2020/technical-preview-2001#bkmk_orch) <!--3098816-->
- [준비 확인 작업 순서 단계의 향상된 기능](/sccm/core/get-started/2020/technical-preview-2001#bkmk_tsready) <!--6005561-->
- [Power BI Report Server 통합](/sccm/core/get-started/2020/technical-preview-2001#bkmk_powerbi) <!--3721603-->
- [OneTrace 로그 그룹](/sccm/core/get-started/2020/technical-preview-2001#bkmk_onetrace) <!--5559993-->
- [관리 서비스의 향상된 기능](/sccm/core/get-started/2020/technical-preview-2001#bkmk_rest) <!--5728365-->
- [중앙 관리 사이트에서 디바이스 절전 모드 해제](/sccm/core/get-started/2020/technical-preview-2001#bkmk_wake) <!--6030715-->
- [작업 순서 진행률의 향상된 기능](/sccm/core/get-started/2020/technical-preview-2001#bkmk_tsprogress) <!--2356386-->
...
현재 분기 버전 1910 이후 Configuration Manager 기술 미리 보기 분기와 함께 다음 기능이 릴리스되었습니다.
