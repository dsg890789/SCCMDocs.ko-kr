---
title: "Exchange ActiveSync 메일 프로필 만들기 | System Center Configuration Manager"
...
Exchange ActiveSync 메일 프로필을 배포하는 방법에 대한 자세한 내용은 [System Center Configuration Manager의 프로필 배포](deploy-wifi-vpn-email-cert-profiles.md)를 참조하세요.  
