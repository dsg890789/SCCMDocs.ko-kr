...
-   Configuration Manager에 사용할 수 있도록 필수 조건과 지원되는 구성을 충족하는 개별 서버를 준비하고 구성합니다([사이트 및 사이트 시스템 필수 조건](../../../../core/plan-design/configs/site-and-site-system-prerequisites.md) 참조).  
