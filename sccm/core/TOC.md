...
#### [클라이언트에서 제거되거나 사용되지 않음](plan-design/changes/deprecated/removed-and-deprecated-client.md)
...
#### [Azure AD를 사용하여 클라이언트 설치](clients/deploy/deploy-clients-cmg-azure.md)
...
####  [클라우드 관리 게이트웨이에 대한 보안 및 개인 정보](clients/manage/cmg/security-and-privacy-for-cloud-management-gateway.md)
####  [클라우드 관리 게이트웨이에 대한 FAQ](clients/manage/cmg/cloud-management-gateway-faq.md)
####  [클라우드 관리 게이트웨이에 대한 인증서](clients/manage/cmg/certificates-for-cloud-management-gateway.md)
####  [클라우드 관리 게이트웨이 설정](clients/manage/cmg/setup-cloud-management-gateway.md)
####  [클라우드 관리 게이트웨이에서 클라이언트 모니터링](clients/manage/cmg/monitor-clients-cloud-management-gateway.md)
