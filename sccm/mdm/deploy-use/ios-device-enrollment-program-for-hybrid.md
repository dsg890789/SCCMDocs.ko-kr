...
2. **배포 프로그램** > **장치 등록 프로그램** > **장치 관리**으로 관리할 수 있습니다. **디바이스 선택**방법을 지정하고, 디바이스 정보를 제공한 다음 디바이스 **일련번호**, **주문 번호**또는 **CSV 파일 업로드**에 따라 세부 정보를 지정합니다. **서버에 할당**을 선택하고 3단계에서 지정한 <*서버 이름*>을 선택한 후 **확인**을 클릭합니다.  
