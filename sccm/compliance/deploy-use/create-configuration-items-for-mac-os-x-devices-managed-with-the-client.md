...
---
# <a name="create-configuration-items-for-mac-os-x-devices"></a>Mac OS X 장치용 구성 항목 만들기
...
10. 선택 된 **설정 유형** 지정 하 고 필요한 정보를 입력:  
    ...
    -   **스크립트**  
        ...
        -   **재구성 스크립트(선택 사항)** : 필요한 경우 **스크립트 추가**를 선택한 다음 Mac 클라이언트 컴퓨터에서 발견된 비규격 설정을 재구성하기 위해 사용되는 셸 스크립트를 입력합니다.  
            ...
            > [!IMPORTANT]  
            >  Mac 컴퓨터에서 해석할 수 없는 서식 문자를 소개 하지는 되도록 하지 복사 및 붙여넣기 사용 합니다. 대신 스크립트에 입력 합니다.  
...
14. 에 **규칙 만들기** 대화 상자에서 다음 정보를 제공 합니다.  
    ...
    -   규칙 유형에 **값**, 다음 정보를 지정 합니다.  
        ...
        -   **Noncompliance severity for reports**(보고서에 대한 비규격 심각도): 이 비규격 규칙에 실패하면 보고되는 심각도 수준을 지정합니다. 사용할 수 있는 심각도 수준은 다음과 같습니다.  
            ...
            -   **위험(이벤트 포함)** - 이 준수 규칙에 실패한 컴퓨터가 Configuration Manager 보고서에 **위험** 오류 심각도를 보고합니다. Mac 클라이언트 컴퓨터에는 또한이 심각도 수준은 기록합니다.  
...
16. 에 **요약** 페이지에서 새 구성 항목에 대 한 설정을 확인 합니다. 그런 다음 마법사를 완료합니다.  
