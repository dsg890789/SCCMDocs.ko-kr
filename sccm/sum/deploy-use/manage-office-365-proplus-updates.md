...
Configuration Manager 버전 1706부터 Office 365 클라이언트 업데이트가 **Office 365 클라이언트 관리** >**Office 365 업데이트** 노드로 이동되었습니다. 이는 ADR 구성에 영향을 주지 않습니다. 
...
> [!Important]
> Configuration Manager 버전 1706부터는 다음 세부 정보에 유의하세요.
>
