...
기본적으로 델타 검색은&5;분 주기로 실행됩니다. 이는 전체 검색 주기의 일반적인 일정보다 훨씬 자주 발생합니다.  이러한 빈번한 주기는 델타 검색이 전체 검색 주기보다 더 적은 사이트 서버와 네트워크 리소스를 사용하기 때문에 가능합니다. 델타 검색을 사용할 경우 해당 검색 방법에 대해 전체 검색 주기의 빈도를 줄일 수 있습니다.  
