...
System Center Configuration Manager의 현재 분기를 사용하는 경우 버전 1802용 콘솔 내 업데이트를 설치하여 이전 버전의 계층을 업데이트할 수 있습니다. <!-- baseline only statement: -->버전 1802가 [기준 미디어](/sccm/core/servers/manage/updates#bkmk_Baselines)로도 지원되기 때문에 새로운 계층 구조의 첫 번째 사이트를 설치하는 데 설치 미디어를 사용할 수 있습니다.
