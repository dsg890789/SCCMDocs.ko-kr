---
title: "콘텐츠 라이브러리 | System Center Configuration Manager"
...
-   콘텐츠 라이브러리가 특정 드라이브에 설치되지 않도록 하려면 콘텐츠 라이브러리를 만들기 전에 **no_sms_on_drive.sms** 라는 빈 파일을 만들고 이를 드라이브의 루트 폴더로 복사합니다.  
