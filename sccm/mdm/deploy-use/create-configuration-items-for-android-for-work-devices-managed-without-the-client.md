...
7.  마법사의 **장치 설정** 페이지에서 구성하려는 설정 그룹을 선택합니다. 자세한 내용은 이 항목에서 **Android 및 Samsung KNOX 구성 항목 설정 참조**를 참조하고 **다음**을 클릭합니다.  
...
|설정 이름|세부 정보|  
|------------------|-------------|  
|**회사 프로필과 개인 프로필 간의 데이터 공유 허용**|다음 중에서 선택합니다.<br>- **구성되지 않음**<br>- **경계를 넘은 공유 방지**<br>- **Apps in Work profile can handle request from personal profile**(회사 프로필의 앱에서 개인 프로필의 요청을 처리할 수 있음)<br>- **공유 제한 없음**<br>|  
