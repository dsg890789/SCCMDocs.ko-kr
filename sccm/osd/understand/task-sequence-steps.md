...
> [!NOTE]  
>  방금 새 상태 마이그레이션 지점 사이트 역할(SMP)을 설정한 경우 사용자 상태 저장소에 사용할 수 있을 때까지 최대&1;시간이 걸릴 수 있습니다. SMP 가용성을 촉진하기 위해 사이트 제어 파일 업데이트를 트리거하도록 상태 마이그레이션 지점 속성 설정을 조정할 수 있습니다.  
