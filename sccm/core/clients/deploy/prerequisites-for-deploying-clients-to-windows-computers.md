...
클라이언트 강제를 사용하려면 다음 보안 권한이 필요합니다.  
   ...
   -   클라이언트 강제를 사용하여 클라이언트를 컬렉션, 디바이스 및 쿼리에 설치하려면: **컬렉션** 개체에 대한 **리소스 수정** 및 **읽기** 권한.  
...
-   모바일 디바이스의 등록을 구성하려면 다음 보안 권한을 보유하고 있어야 합니다.  
    ...
    -   모바일 디바이스 초기화 또는 사용 중지: **컬렉션** 개체에 대한 **리소스 삭제** .  

    -   초기화 또는 사용 중지 명령 취소: **컬렉션** 개체에 대한 **리소스 삭제** .  

    -   모바일 디바이스 허용 및 차단: **컬렉션** 개체에 대한 **리소스 수정** .  

    -   모바일 디바이스를 원격으로 잠그거나 모바일 디바이스의 암호 다시 설정: **컬렉션** 개체에 대한 리소스 **수정** .  
...
-   모바일 디바이스 및 등록 프록시 지점 간: HTTPS(기본적으로 TCP 443)  
