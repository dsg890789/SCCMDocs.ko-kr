---
title: "유니코드 및 ASCII 지원 | System Center Configuration Manager"
...
---
# <a name="unicode-and-ascii-support-in-system-center-configuration-manager"></a>System Center Configuration Manager에서 유니코드 및 ASCII 지원
...
##  <a name="a-namebkmkasciichara-objects-that-use-ascii-characters"></a><a name="BKMK_ASCIIchar"></a> ASCII 문자를 사용하는 개체  
...
-   다음 Configuration Manager 계정:  
    ...
    > [!NOTE]  
    >  이러한 계정은 러시아 언어로 실행되는 사이트에서 ASCII 문자와 RUS 문자를 지원합니다.  
...
-   다음 폴더의 경로:  
    ...
    -   설치에 사용되는 필수 구성 요소 다운로드가 저장되는 폴더  
...
##  <a name="a-namebkmkothercharlimitationsa-additional-limitations"></a><a name="BKMK_OtherCharLimitations"></a> 추가 제한 사항  
...
##  <a name="a-namebkmklangnonlocalizea-configuration-manager-objects-that-are-not-localized"></a><a name="BKMK_LangNonLocalize"></a> 지역화되지 않은 Configuration Manager 개체  
