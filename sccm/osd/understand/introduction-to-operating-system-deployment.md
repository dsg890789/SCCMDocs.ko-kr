...
##  <a name="a-namebkmkosdscenariosa-operating-system-deployment-scenarios"></a><a name="BKMK_OSDScenarios"></a> 운영 체제 배포 시나리오  
...
##  <a name="a-namebkmkbootimagesa-boot-images"></a><a name="BKMK_BootImages"></a> 부팅 이미지  
