...
description: Configuration Manager Technical Preview 분기 버전 1809에서 사용할 수 있는 새로운 기능에 대해 알아봅니다.
ms.date: 09/12/2018
...
ms.locfileid: "75803985"
---
# <a name="capabilities-in-configuration-manager-technical-preview-version-1809"></a>Configuration Manager Technical Preview 버전 1809의 기능 

*적용 대상: Configuration Manager(기술 미리 보기 분기)*

이 문서에서는 Configuration Manager에 대한 Technical Preview 버전 1809에서 사용할 수 있는 기능을 소개합니다. 이 버전을 설치하여 기술 미리 보기 사이트를 업데이트하고 새 기능을 추가합니다. 
