...
|**모든 Windows 앱**|설치된 Windows 앱의 요약 정보가 표시됩니다. 응용 프로그램 이름, 아키텍처 또는 게시자를 기준으로 사용하여 검색합니다.|  
...
|**응용 프로그램 인프라 오류**|응용 프로그램 인프라 오류가 표시됩니다. 이러한 오류에는 내부 인프라 문제 또는 잘못된 요구 사항 규칙으로 인한 오류가 포함됩니다.|  
|**응용 프로그램 사용량 세부 상태**|설치된 응용 프로그램에 대한 사용량 세부 정보가 표시됩니다.|  
|**응용 프로그램 사용량 요약 상태**|설치된 응용 프로그램에 대한 사용량 요약이 표시됩니다.|  
|**배포에 실패한 iOS 앱(앱이 이미 설치됨)**|선택한 iOS 앱에 대한 준수 정보가 표시됩니다. 이 자습서에서는 이 앱을 '앱 스토어의 iOS용 앱 패키지'로 배포하고, 모바일 응용 프로그램 관리 정책과 연결했습니다. 이 보고서는 사용자가 이미 수동으로 설치했기 때문에 앱이 설치하지 못한 사용자 및 디바이스를 표시하는 데 사용됩니다.|  
...
|**계량된 프로그램이 설치되었지만 지정된 날짜 이후에 해당 프로그램을 실행하지 않은 컴퓨터**|지정된 계량형 응용 프로그램이 있는 모든 컴퓨터를 표시하지만, 지정된 날짜 이후로 프로그램을 실행한 사용자가 없습니다.|  
...
|보고서 이름|설명|  
|-----------------|-----------------|  
|**라이선스 수가 포함된 iOS용 Apple Volume Purchase Program 앱**|Apple Volume Purchase Program을 통해 라이선스를 획득한 모든 iPhone, iPad 및 iPod Touch 응용 프로그램이 표시됩니다. 응용 프로그램별로 구매한 전체 라이선스 및 사용한 라이선스도 이 보고서에 포함됩니다.|  
