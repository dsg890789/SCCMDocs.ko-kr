...
> [!TIP]  
> 버전 1610의 경우 피어 캐시 및 클라이언트 데이터 원본 대시보드는 시험판 기능입니다. 이러한 기능을 사용하도록 설정하려면 [업데이트에서 시험판 기능 사용](/sccm/core/servers/manage/install-in-console-updates#bkmk_prerelease)을 참조하세요. **클라이언트 데이터 원본** 대시보드는 사용하도록 설정한 후에만 표시됩니다. 사용하도록 설정한 후 데이터를 표시하는 데 최대 24시간이 걸릴 수 있습니다. 
