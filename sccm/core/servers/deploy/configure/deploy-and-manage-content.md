...
2.  **소프트웨어 라이브러리** 작업 영역에서 배포할 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리** > **애플리케이션**을 확장한 다음, 배포할 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리** >  **패키지**를 확장한 다음, 배포할 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트** >  **배포 패키지**를 확장한 다음, 배포할 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제** >  **드라이버 패키지**를 확장한 다음, 배포할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제** >  **운영 체제 이미지**를 확장한 다음, 배포할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제** > **운영 체제 설치 관리자**를 확장한 다음, 배포할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제** >  **부팅 이미지**를 확장한 다음, 배포할 부팅 이미지를 선택합니다.  

    -   **작업 순서**: **운영 체제** >  **작업 순서**를 클릭한 후에 배포할 작업 순서를 선택합니다. 작업 순서에 콘텐츠가 포함되어 있지 않더라도 배포되는 연결된 콘텐츠 종속성을 갖습니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 사전 준비할 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리**를 확장하고 **애플리케이션**을 클릭한 다음, 사전 준비할 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리**를 확장하고 **패키지**를 클릭한 다음, 사전 준비할 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제**를 확장하고 **드라이버 패키지**를 클릭한 다음, 사전 준비할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제**를 확장하고 **운영 체제 이미지**를 클릭한 다음, 사전 준비할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제**를 확장하고 **운영 체제 설치 관리자**를 클릭한 다음, 사전 준비할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제**를 확장하고 **부팅 이미지**를 클릭한 다음, 사전 준비할 부팅 이미지를 선택합니다.  

    -   **작업 순서**: **운영 체제**를 확장하고 **작업 순서**를 클릭한 다음, 사전 준비할 작업 순서를 선택합니다.  

3.  **홈** 탭의 **배포** 그룹에서 **사전 준비된 콘텐츠 파일 만들기**를 클릭합니다. 사전 준비된 콘텐츠 파일 만들기 마법사가 열립니다.  

    > [!NOTE]  
    >  **애플리케이션:** **홈** 탭의 **애플리케이션** 그룹에서 **사전 준비된 콘텐츠 파일 만들기**를 클릭합니다.  
    >   
    >  **패키지:** **홈**탭의 &lt;*패키지 이름*> 그룹에서 **사전 준비된 콘텐츠 파일 만들기**를 클릭합니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 사전 준비된 콘텐츠 파일을 만들 때 선택한 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리**를 확장하고 **애플리케이션**을 클릭한 다음, 사전 준비한 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리**를 확장하고 **패키지**를 클릭한 다음, 사전 준비한 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트**를 확장하고 **배포 패키지**를 클릭한 다음, 사전 준비한 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제**를 확장하고 **드라이버 패키지**를 클릭한 다음, 사전 준비한 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제**를 확장하고 **운영 체제 이미지**를 클릭한 다음, 사전 준비한 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제**를 확장하고 **운영 체제 설치 관리자**를 클릭한 다음, 사전 준비한 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제**를 확장하고 **부팅 이미지**를 클릭한 다음, 사전 준비한 부팅 이미지를 선택합니다.  
...
2.  이 항목의 [1단계: 사전 준비된 콘텐츠 파일](#BKMK_CreatePrestagedContentFile) 섹션을 사용하여 사전 준비된 콘텐츠 파일을 만듭니다.  

3.  이 항목의 [2단계: 배포 지점에 콘텐츠 할당](#BKMK_AssignContentToDistributionPoint) 섹션을 사용하여 콘텐츠를 배포 지점에 할당합니다.  

4.  이 항목의 [3단계: 사전 준비된 콘텐츠 파일에서 콘텐츠 추출](#BKMK_ExportContentFromPrestagedContentFile) 섹션을 사용하여 콘텐츠를 추출합니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 배포할 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리** > **애플리케이션**을 확장한 다음, 배포할 애플리케이션을 선택합니다. **배포 유형** 탭을 클릭하고 업데이트할 배포 유형을 선택합니다.  

    -   **패키지**: **애플리케이션 관리** > **패키지**를 확장한 다음, 업데이트할 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트** > **배포 패키지**를 확장한 다음, 업데이트할 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제** > **드라이버 패키지**를 확장한 다음, 업데이트할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제** > **운영 체제 이미지**를 확장한 다음, 업데이트할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제** > **운영 체제 설치 관리자**를 확장한 다음, 업데이트할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제** >  **부팅 이미지**를 확장한 다음, 업데이트할 부팅 이미지를 선택합니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 배포할 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리** >  **애플리케이션**을 확장한 다음, 재배포할 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리** > **패키지**를 확장한 다음, 재배포할 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트** >  **배포 패키지**를 확장한 다음, 재배포할 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제** > **드라이버 패키지**를 클릭한 다음, 재배포할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제** > **운영 체제 이미지**를 클릭한 다음, 재배포할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제** > **운영 체제 설치 관리자**를 클릭한 다음, 재배포할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제** >  **부팅 이미지**를 확장한 다음, 재배포할 부팅 이미지를 선택합니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 삭제할 콘텐츠 유형에 맞춰 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리** > **애플리케이션**을 확장한 다음, 제거할 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리** > **패키지**를 확장한 다음, 제거할 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트** > **배포 패키지**를 확장한 다음, 제거할 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제** > **드라이버 패키지**를 클릭한 다음, 제거할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제** > **운영 체제 이미지**를 클릭한 다음, 제거할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제** > **운영 체제 설치 관리자**를 클릭한 다음, 제거할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제** > **부팅 이미지**를 확장한 다음, 제거할 부팅 이미지를 선택합니다.  
...
2.  **소프트웨어 라이브러리** 작업 영역에서 유효성 검사를 수행할 콘텐츠 유형에 대한 다음 단계 중 하나를 선택합니다.  
    ...
    -   **애플리케이션**: **애플리케이션 관리** > **애플리케이션**을 확장한 다음, 유효성을 검사할 애플리케이션을 선택합니다.  

    -   **패키지**: **애플리케이션 관리** > **패키지**를 확장한 다음, 유효성을 검사할 패키지를 선택합니다.  

    -   **배포 패키지**: **소프트웨어 업데이트** > **배포 패키지**를 확장한 다음, 유효성을 검사할 배포 패키지를 선택합니다.  

    -   **드라이버 패키지**: **운영 체제** > **드라이버 패키지**를 클릭한 다음, 유효성을 검사할 드라이버 패키지를 선택합니다.  

    -   **운영 체제 이미지**: **운영 체제** > **운영 체제 이미지**를 클릭한 다음, 유효성을 검사할 운영 체제 이미지를 선택합니다.  

    -   **운영 체제 설치 관리자**: **운영 체제** >  **운영 체제 설치 관리자**를 클릭한 다음, 유효성을 검사할 운영 체제 설치 관리자를 선택합니다.  

    -   **부팅 이미지**: **운영 체제** > **부팅 이미지**를 확장한 다음, 유효성을 검사할 부팅 이미지를 선택합니다.  
