...
자세한 내용은 [Microsoft Store For Business 개요](https://docs.microsoft.com/microsoft-store/microsoft-store-for-business-overview)를 참조 하세요.
...
- 비즈니스에 대 한 Microsoft Store를 관리 도구로 등록 한 동일한 Azure AD 테 넌 트에 장치를 등록 하거나 조인 합니다.  
...
조직에서 획득한 비즈니스용 Microsoft Store 목록을 동기화하면 Configuration Manager 콘솔에서 이러한 앱을 볼 수 있습니다.
...
서비스 연결 지점 및 대상 장치에서 클라우드 서비스에 액세스할 수 있는지 확인 합니다. 자세한 내용은 [Microsoft Store For Business proxy configuration](https://docs.microsoft.com/microsoft-store/prerequisites-microsoft-store-for-business#proxy-configuration)을 참조 하세요.
...
동기화 후 다른 Configuration Manager 응용 프로그램과 유사한 비즈니스 앱에 대 한 Microsoft Store를 만들어 배포 합니다.
...
[Configuration Manager와의 비즈니스 통합 Microsoft Store 문제 해결](/sccm/apps/deploy-use/troubleshoot-microsoft-store-for-business-integration)
