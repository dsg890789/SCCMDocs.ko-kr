...
1.  Configuration Manager 콘솔에서 **자산 및 호환성** 작업 영역으로 이동하고 **장치** 노드를 선택합니다. **장치 컬렉션** 노드에서 모든 컬렉션을 선택할 수도 있습니다.  

2.  장치를 선택합니다. 리본에 있는 **홈** 탭 및 **장치** 그룹에서 **시작**을 클릭한 다음, **리소스 탐색기**를 선택합니다.   
