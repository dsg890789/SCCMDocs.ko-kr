...
> [!IMPORTANT]
    >스크립트 실행 기능을 사용할 때는 디바이스 다시 부팅 또는 Configuration Manager 에이전트 다시 시작 스크립트를 사용하지 마세요. 그러면 연속 다시 부팅 상태가 될 수 있습니다. 필요한 경우, Configuration Manager 버전 1710부터는 디바이스를 다시 시작할 수 있는 클라이언트 알림 기능에 대한 개선 사항이 있습니다. [다시 시작 보류 중 열](/sccm/core/clients/manage/manage-clients#Restart-clients)을 통해 다시 시작해야 하는 장치를 식별할 수 있습니다. 
<!--SMS503978  -->
