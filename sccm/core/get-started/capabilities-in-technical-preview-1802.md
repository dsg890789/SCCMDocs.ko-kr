...
<!-- 1357580 -->
Technical Preview 버전 1706에서 처음 도입된 [새 PXE 기능](/sccm/core/get-started/capabilities-in-technical-preview-1706#pxe-network-boot-support-for-ipv6)의 동작을 명확히 나타내기 위해 **IPv6 지원** 옵션의 이름이 바뀌었습니다. 배포 지점 속성의 **PXE** 탭에서 **Windows 배포 서비스 없이 PXE 응답기 사용**을 선택합니다. 
...
## <a name="improvements-to-configuration-manager-policies-for-windows-device-exploit-guard"></a>Windows Device Exploit Guard에 대한 Configuration Manager 정책 개선 사항
<!-- 1356220 -->
Configuration Manager의 Windows Device Exploit Guard에서 공격 노출 영역 축소 및 제어된 폴더 액세스 구성 요소에 대한 정책 설정이 추가되었습니다.

**제어된 폴더 액세스에 대한 새 설정**<br/>
제어된 폴더 액세스를 구성할 때 **디스크 섹터만 차단** 및 **디스크 섹터만 감사**의 두 가지 추가 옵션이 있습니다. 이 두 가지 설정을 사용하면 제어된 폴더 액세스를 부트 섹터에만 사용할 수 있으며, 특정 폴더 또는 기본 보호된 폴더의 보호는 사용되지 않습니다. 
...
<!-- 1357310 -->
Windows 10 클라이언트에서 [Microsoft Edge](https://technet.microsoft.com/microsoft-edge/bb265256) 웹 브라우저를 사용하는 고객의 경우 이제 Configuration Manager 준수 설정 정책을 만들어 여러 Microsoft Edge 설정을 구성할 수 있습니다. 이 정책에는 현재 다음 설정이 포함되어 있습니다.
