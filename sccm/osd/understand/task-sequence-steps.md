---
title: "작업 순서 단계 | Configuration Manager"
 ...
 **ConfigMgr 클라이언트 캡처 준비** 단계를 사용하여 참조 컴퓨터에서 Configuration Manager 클라이언트를 가져오고 다음 작업을 통해 이미징 프로세스의 일부로 클라이언트 캡처를 준비할 수 있습니다.  
 ...
 **시간 제한**  
 Configuration Manager에서 명령줄 실행을 허용할 시간을 나타내는 값을 지정합니다. 이 값은 10분에서 999분 사이일 수 있습니다. 기본값은 15분입니다.  
