...
|**사용자 동의 없이 설치된 응용 프로그램 검색**|Windows Defender에서 사용자 동의 없이 설치된 소프트웨어로 분류된 프로그램에 대해 등록된 Windows 데스크톱 디바이스를 보호할 수 있습니다. 이러한 애플리케이션이 실행되지 않도록 장치를 보호하거나, 감사 모드를 사용하여 애플리케이션이 사용자 동의 없이 설치될 때 보고할 수 있습니다.|
