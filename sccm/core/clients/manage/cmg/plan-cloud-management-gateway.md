...
- 공동 관리를 사용하여 새 디바이스를 프로비전합니다. CMG는 공동 관리에 필요하지 않습니다. Windows AutoPilot, Azure AD, Microsoft Intune 및 Configuration Manager와 관련된 새 디바이스에 대한 종단 간 시나리오를 완료하는 데 도움이 됩니다.  
