...
8. 마법사의 **디바이스 설정** 페이지에서 구성하려는 설정 그룹을 선택합니다. 자세한 내용은 이 문서의 [Windows 10 configuration item settings reference](#BKMK_Ref)(Windows 10 구성 항목 설정 참조) 섹션을 참조하고 **다음**을 클릭합니다.  
