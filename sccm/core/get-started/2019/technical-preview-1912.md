...
description: Configuration Manager 기술 미리 보기 분기 버전 1912에서 사용할 수 있는 새로운 기능에 대해 알아봅니다.
ms.date: 12/12/2019
...
ms.locfileid: "75198977"
---
# <a name="features-in-configuration-manager-technical-preview-version-1912"></a>Configuration Manager 기술 미리 보기 버전 1912의 기능

*적용 대상: Configuration Manager(기술 미리 보기 분기)*

이 아티클에서는 Configuration Manager 기술 미리 보기 버전 1912에서 사용할 수 있는 기능을 소개합니다. 이 버전을 설치하여 기술 미리 보기 사이트를 업데이트하고 새 기능을 추가합니다.
