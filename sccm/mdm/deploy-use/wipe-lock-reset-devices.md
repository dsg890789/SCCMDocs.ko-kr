...
|인증서|제거되고 해지됩니다.|  
|설정|다음을 제외하고 제거됩니다. **로밍 하는 동안** **음성 로밍을 허용**하 고, **데이터 로밍을**허용 하 고, 자동 동기화를 허용 합니다.|  
...
|전자 메일 프로필|이 오류에는 이 작업을 적용할 수 없습니다.|Intune에 의해 설정된 메일 프로필의 경우 메일 계정 및 메일이 제거됩니다.|  
...
|인증서|제거되고 해지됩니다.|  
|설정|요구 사항이 제거됩니다.|
|관리 에이전트|이 오류에는 이 작업을 적용할 수 없습니다. 관리 에이전트가 기본 제공됨|  
...
| Android for Work                      | 지원되지 않습니다.                                                                               |
| Windows 10 PC                        | 지원 안 됨                                                                               |
| Windows 10 Mobile                     | Azure AD 결합 디바이스를 제외하고 지원됩니다.  |
| Windows Phone 8 및 Windows Phone 8.1 | 지원됩니다.                                                                                   |
| Windows RT 8.1                        | 지원되지 않습니다.                                                                               |
| Windows 8.1 PC                       | 지원되지 않습니다.                                                                               |
