...
1. 구성 항목 만들기 마법사의 **Samsung KNOX 디바이스에 대한 키오스크 모드 설정 구성** 페이지에서 다음 정보를 지정합니다.  
   ...
   |설정|자세한 정보|  
   |-------------|----------------------|  
   |**앱 선택**|**찾아보기**를 선택하여 디바이스가 키오스크 모드일 때 실행할 수 있는 Configuration Manager Android 응용 프로그램(확장명이 **.apk**임)을 선택합니다. 다른 앱은 디바이스에서 실행할 수 없습니다.|  
