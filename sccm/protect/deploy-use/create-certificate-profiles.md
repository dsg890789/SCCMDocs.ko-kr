---
title: "인증서 프로필 만들기 | System Center Configuration Manager"
...
---
# <a name="how-to-create-certificate-profiles-in-system-center-configuration-manager"></a>System Center Configuration Manager에서 인증서 프로필을 만드는 방법

*적용 대상: System Center Configuration Manager(현재 분기)*


인증서 프로필을 사용하면 관리되는 장치를 회사 리소스에 액세스하는 데 필요한 인증서로 프로비전할 수 있습니다. 인증서 프로필을 만들기 전에 [System Center Configuration Manager에 대한 인증서 인프라 설정](certificate-infrastructure.md)에 설명된 대로 인증서 인프라를 설정합니다.  
...
2.  **자산 및 준수** 작업 영역에서 ** 설정**및 **회사 리소스 액세스**를 각각 확장하고 **인증서 프로필**을 클릭합니다.  
...
1.  인증서 프로필 만들기 마법사의 **일반** 페이지에서 다음 정보를 지정합니다.  
...
2.  아래 지침에 따라 인증서 프로필 만들기 마법사의 **SCEP 등록** 페이지를 완료합니다.
