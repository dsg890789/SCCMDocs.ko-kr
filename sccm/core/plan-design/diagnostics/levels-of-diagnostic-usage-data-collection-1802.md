...
- 구성된 원격 분석 수준, 온라인 또는 오프라인 모드 및 빠른 업데이트 구성
...
- ***[Moved]*** 비즈니스용 Windows 업데이트를 사용하는 Windows 10 클라이언트 개수  
...
- ***[Moved]*** Azure Active Directory에 가입한 클라이언트 개수

- ***[New]*** 형식에서 생성하는 단계적 배포 개수

- ***[New]*** 확장된 상호 운용성 클라이언트 개수

- ***[New]*** 255자보다 긴 하드웨어 인벤토리 속성의 해시된 목록
...
### <a name="content"></a>Content  
  ...
  - ***[Updated]*** 경계 그룹 통계: 빠른 정도, 느린 정도, 그룹별 개수 및 대체 관계
...
### <a name="software-updates"></a>소프트웨어 업데이트  
   ...
   - ***[New]*** 비즈니스용 Windows Update 구성의 집계된 통계
