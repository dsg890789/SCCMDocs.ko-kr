              ...
              <ul class="row">
                ...
                <li class="column-third">
                  <a href="/sccm/sum/deploy-use/deploy-software-updates">
                    <h3>소프트웨어 업데이트 배포</h3>
                    <p>소프트웨어 업데이트 인프라가 구축된 후 소프트웨어 업데이트를 배포하는 방법을 알아보려면 이 섹션을 참조하세요.</p>
                  </a>
                </li>
              </ul>
            </section>
...
<li class="journey-step">
    ...
    <div class="section-border">
      ...
      <div class="resource-list row">
          ...
          <ul class="column-half">
          <li><a href="https://technet.microsoft.com/library/gg682129.aspx" target="_blank">System Center 2012 Configuration Manager 문서</a></li>
