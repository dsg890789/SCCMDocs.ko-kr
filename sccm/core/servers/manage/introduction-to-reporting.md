---
title: "보고 기능 소개 | Configuration Manager"
...
##  <a name="a-namebkmkreportingservicespointa-reporting-services-point"></a><a name="BKMK_ReportingServicesPoint"></a> 보고 서비스 지점  
...
##  <a name="a-namebkmkconfigurationmanagerreportsa-configuration-manager-reports"></a><a name="BKMK_ConfigurationManagerReports"></a> Configuration Manager 보고서  
...
###  <a name="a-namebkmkcreatingreportsa-creating-and-modifying-reports"></a><a name="BKMK_CreatingReports"></a> 보고서 만들기 및 수정  
...
###  <a name="a-namebkmkrunningreportsa-running-reports"></a><a name="BKMK_RunningReports"></a> 보고서 실행  
...
###  <a name="a-namebkmkreportpromptsa-report-prompts"></a><a name="BKMK_ReportPrompts"></a> 보고서 프롬프트  
...
###  <a name="a-namebkmkreportlinksa-report-links"></a><a name="BKMK_ReportLinks"></a> 보고서 링크  
...
##  <a name="a-namebkmkreportfoldersa-report-folders"></a><a name="BKMK_ReportFolders"></a> 보고서 폴더  
...
##  <a name="a-namebkmkreportsubscriptionsa-report-subscriptions"></a><a name="BKMK_ReportSubscriptions"></a> 보고서 구독  
...
##  <a name="a-namebkmkreportbuildera-report-builder"></a><a name="BKMK_ReportBuilder"></a> 보고서 작성기  
...
##  <a name="a-namebkmkreportmodelsa-report-models-in-sql-server-reporting-services"></a><a name="BKMK_ReportModels"></a> SQL Server Reporting Services의 보고서 모델  
