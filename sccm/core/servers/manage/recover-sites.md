...
예를 들어 사이트 오류 전에 **총 활성화** 수는 **100**으로 표시됩니다. 장치가 사용한 키의 수 또는 **사용된 활성화** 수는 **90**입니다. 사이트 복구 후 **총 활성화**는 여전히 값을 **100**으로 표시하지만 **사용된 활성화** 열은 **0**으로 잘못 표시합니다. 10개의 새 장치에서 테스트용 로드 키를 사용한 후에는 더 이상 테스트용 로드 키가 없으며 11번째 장치에서 테스트용 로드 키를 적용하지 못합니다.
