...
응용 프로그램 승인 요청에 대한 메일 알림을 구성합니다. 사용자가 응용 프로그램을 요청하면 메일을 받게 됩니다. 메일의 링크를 클릭하면 Configuration Manager 콘솔을 사용하지 않고 요청을 승인 또는 거부할 수 있습니다.
...
이러한 필수 구성 요소를 구성하지 않으면 사이트에서는 요청을 승인 또는 거부하기 위한 링크 없이 응용 프로그램 요청에 대한 메일 알림을 보냅니다.  
...
1. Configuration Manager 콘솔에서 사용자 컬렉션에 사용할 수 있는 것으로 응용 프로그램을 배포합니다. **배포 설정** 페이지에서 승인을 위해 사용하도록 설정합니다. 그런 다음, 알림을 받을 *단일* 메일 주소를 입력합니다.  
