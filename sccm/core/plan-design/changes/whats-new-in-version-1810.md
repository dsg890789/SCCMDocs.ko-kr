...
자세한 내용은 [Wake on LAN 구성](/sccm/core/clients/deploy/configure-wake-on-lan) 및 [클라이언트의 절전 모드 해제 방법](/sccm/core/clients/deploy/plan/plan-wake-up-clients)을 참조하세요.
...
자세한 내용은 [공동 관리 워크로드](/sccm/comanage/workloads)를 참조하세요.
...
추가 필터가 Windows 10 서비스 계획에 추가되었습니다. 이제 업그레이드가 **대체됨**인 경우 **아키텍처** 및 **제품 범주**별로 필터링할 수 있습니다.
...
<!--vso2839307-->
다음 클라이언트 설정은 유지 관리 기간에서 **소프트웨어 업데이트**의 설치 동작을 제어하는 소프트웨어 업데이트 그룹에 있습니다. **"소프트웨어 업데이트" 유지 관리 기간을 사용할 수 있는 경우 "모든 배포" 유지 관리 기간에서 업데이트 설치 사용**
...
<!--3098809, 2977644-->
이제 비기능 업데이트와 별도로 기능 업데이트에 대한 대체 규칙을 지정할 수 있습니다. 즉, Windows 10 클라이언트 서비스를 완료하기 전에 Configuration Manager에서 업그레이드가 제거되지 않습니다.
...
CMPivot에 대한 자세한 내용은 [CMPivot](/sccm/core/servers/manage/cmpivot)을 참조하세요.
...
<!--3607711, fka 1321523-->
SMS 공급자는 이제 **관리 서비스**라고 하는 WMI에 대한 읽기 전용 API 상호 운용성 액세스(HTTPS 이용)를 제공합니다. 사이트의 정보에 액세스하는 데 사용자 지정 웹 서비스 대신에 REST API를 사용할 수 있습니다.
...
다음 업데이트 롤업(4488598)은 2019년 3월 25일부터 콘솔에서 사용할 수 있습니다. [Configuration Manager 현재 분기, 버전 1810용 업데이트 롤업 2](https://support.microsoft.com/help/4488598). 이 업데이트 롤업은 이전 업데이트 롤업 KB 4486457을 대체합니다.
