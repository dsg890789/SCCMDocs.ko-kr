---
title: "사용해야 하는 분기 | System Center Configuration Manager"
...
*적용 대상: System Center Configuration Manager(현재 분기), (장기 서비스 분기), (기술 미리 보기)*
...
최신 기능 및 특성을 가져오는 옵션을 원하는 프로덕션 환경에서 사용하기 위한 사용이 허가된 분기입니다. System Center 데이터 센터, System Center 표준, System Center Configuration Manager 또는 동등한 구독 권한 중 하나가 있을 경우 사용해야 하는 분기입니다.  Software Assurance 및 라이선스 옵션에 대한 자세한 내용은 [System Center Configuration Manager의 라이선스 및 분기](learn-more-editions.md)를 참조하세요.
...
>  [!NOTE]
> 새 Configuration Manager 계층 구조의 사이트를 설치하려는 경우에만 기준 미디어를 사용합니다. 버전 1511 등의 기준 버전을 이전에 설치한 경우 콘솔 내 업데이트를 사용하여 1606 등의 새 버전으로 사이트를 업데이트합니다.
>
...
- 평가판 설치로 설치를 지원하며, 나중에 정식 라이선스 설치로 업그레이드할 수 있습니다.
...
##  <a name="long-term-servicing-branch-ltsb-of-system-center-configuration"></a>System Center 구성의 LTSB(장기 서비스 분기)
현재 분기를 사용하며 Configuration Manager SA(Software Assurance) 또는 동등한 구독 권한이 2016년 10월 1일 후에 만료되도록 허용한 Configuration Manager 고객이 프로덕션에서 사용하도록 사용이 허가된 분기입니다.  Software Assurance 및 라이선스 옵션에 대한 자세한 내용은 [System Center Configuration Manager의 라이선스 및 분기](learn-more-editions.md)를 참조하세요.
...
> [!TIP]  
> System Center 2016에 대해 알아보려면 [System Center 2016 설명서](https://technet.microsoft.com/system-center-docs/System-Center-2016)를 참조하세요. 이 설명서에서는 Microsoft 사용권 계약 또는 유사한 권한이 필요한 System Center 2016을 다운로드하는 방법도 설명합니다.  [TechNet 평가 센터](https://www.microsoft.com/evalcenter/evaluate-system-center-technical-preview)에서 System Center 2016 평가판을 다운로드할 수도 있습니다.
