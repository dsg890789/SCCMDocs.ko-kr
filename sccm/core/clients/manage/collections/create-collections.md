...
##  <a name="BKMK_1"></a> 디바이스 컬렉션을 만들려면  

1.  Configuration Manager 콘솔에서 **자산 및 준수** > **장치 컬렉션**을 선택합니다.  

3.  **홈** 탭의 **만들기** 그룹에서 **디바이스 컬렉션 만들기**를 선택합니다.  

4.  **일반** 페이지에서는 **이름** 및 **설명**을 제공합니다. 그런 다음 **제한 컬렉션**에서 **찾아보기**를 선택하여 제한 컬렉션을 선택합니다. 컬렉션에는 제한 컬렉션 멤버만 포함됩니다.  

5.  **디바이스 컬렉션 만들기 마법사**의 **멤버 관리 규칙** 페이지에 있는 **규칙 추가** 목록에서 이 컬렉션에 사용하려는 멤버 관리 규칙의 유형을 선택합니다. 각 컬렉션에 대해 여러 규칙을 구성할 수 있습니다.  
