...
###  <a name="BKMK_SoftwareLabels"></a> 소프트웨어 레이블  
 Asset Intelligence 사용자 지정 소프트웨어 레이블을 소프트웨어 타이틀을 그룹화 하 고 Asset Intelligence 보고서를 사용 하 여 볼를 사용할 수 있는 필터를 만들 수 있습니다. 예를 들어 셰어웨어라는 소프트웨어 레이블을 만들고 여러 애플리케이션과 연결한 다음 셰어웨어의 소프트웨어 레이블을 사용하는 모든 타이틀을 표시하는 보고서를 만들 수 있습니다. Asset Intelligence 카탈로그에 추가하는 모든 사용자 지정 소프트웨어 레이블에 대한 유효성 검사 상태는 **사용자 정의됨** 입니다.  
...
5. **일반** 탭에서 다음 분류 정보를 수정할 수 있습니다.  
   ...
   -   **제품군**: 인벤토리에 포함된 소프트웨어 타이틀에 현재 할당되어 있는 소프트웨어 제품군을 지정합니다.  
...
6. 소프트웨어 세부 정보 충돌을 해결하려면 다음 설정 중 하나를 선택합니다.  
   ...
   - **로컬로 편집한 카탈로그 정보 값을 변경하지 마세요**: 기존 Asset Intelligence 카탈로그 소프트웨어 분류 정보를 유지하여 소프트웨어 세부 정보 충돌을 해결합니다. 이 설정을 선택하면 소프트웨어 타이틀 상태가 **업데이트 가능** 에서 **사용자 정의됨**으로 변경됩니다.  

   - **로컬로 편집한 카탈로그 정보 값을 다운로드한 System Center Online 값으로 덮어쓰기**: 기존 Asset Intelligence 카탈로그 소프트웨어 분류 정보를 System Center Online에서 얻은 새 정보로 덮어써서 소프트웨어 세부 정보 충돌을 해결합니다. 이 설정을 선택하면 소프트웨어 타이틀 상태가 **업데이트 가능** 에서 **유효성 확인됨**으로 변경됩니다.  
