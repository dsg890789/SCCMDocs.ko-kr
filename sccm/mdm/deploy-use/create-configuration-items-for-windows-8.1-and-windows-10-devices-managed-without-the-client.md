...
---
# <a name="create-configuration-items-for-windows-81-and-windows-10-devices-managed-with-intune"></a>Intune을 사용하여 관리되는 Windows 8.1 및 Windows 10 장치에 대한 구성 항목 만들기
...
8.  **장치 설정** 페이지에서 구성하려는 설정 그룹을 선택합니다. 자세한 내용은 이 항목에서 [Windows 8.1 및 Windows 10 구성 항목 설정 참조](#windows-81-and-windows-10-configuration-item-settings-reference)를 참조하고 **다음**을 클릭합니다.  
