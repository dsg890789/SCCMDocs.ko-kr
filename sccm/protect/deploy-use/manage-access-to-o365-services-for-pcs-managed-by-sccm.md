---
title: "관리되는 PC용 O365 서비스에 대한 액세스 관리 | System Center Configuration Manager"
...
> [!IMPORTANT]  
>  이 기능은 업데이트 1602와 업데이트 1606에서 사용할 수 있는 시험판 기능입니다. 시험판 기능은 프로덕션 환경의 초기 테스트를 위한 제품에 포함되었지만 이러한 기능은 프로덕션 준비가 된 것으로 간주되지 않아야 합니다. 자세한 내용은 [업데이트에서 시험판 기능 사용](../../core/servers/manage/install-in-console-updates.md#bkmk_prerelease)을 참조하세요.
...
6.  **대상 그룹**에서 **수정** 을 클릭하여 정책을 적용할 Azure Active Directory 보안 그룹을 선택합니다.  
    ...
    > [!NOTE]  
    >  조건부 액세스 정책이 적용되는 사용자 그룹에는 규정 준수 정책도 적용되어야 합니다.  
...
##  <a name="a-namebkmkknownissuesa-known-issues"></a><a name="bkmk_KnownIssues"></a> 알려진 문제  
