...
4.  **소프트웨어 배포 마법사**의 **일반** 페이지에서 **찾아보기**를 선택하여 **모든 시스템** 디바이스 컬렉션을 선택합니다.  

5.  **콘텐츠** 페이지에서 애플리케이션을 설치할 PC의 배포 지점이 선택되었는지 확인합니다.  
...
7.  **일정** 페이지에서 애플리케이션이 설치되는 시기를 구성할 수 있습니다. 이 예에서는 **사용 가능해지면 되도록 빨리**를 선택합니다.  
