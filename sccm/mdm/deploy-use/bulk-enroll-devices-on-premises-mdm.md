...
description: Configuration Manager에서 온-프레미스 모바일 장치 관리를 사용 하 여 자동화 된 방식으로 장치를 대량 등록 합니다.
ms.date: 03/05/2017
...
##  <a name="bkmk_createCert"></a> 인증서 프로필 만들기  
 ...
 내보낸 루트 인증서를 사용하여 인증서 프로필을 만듭니다. 자세한 내용은 [인증서 프로필을 만드는 방법](../../protect/deploy-use/create-certificate-profiles.md)을 참조 하세요.  
...
##  <a name="CreateWifi"></a> Wi-Fi 프로필 만들기  
 ...
 Configuration Manager에서 Wi-fi 프로필을 만들려면 [wi-fi 프로필을 만드는 방법](../../protect/deploy-use/create-wifi-profiles.md)의 지침을 따르세요.  
