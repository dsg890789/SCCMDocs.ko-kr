...
---
# <a name="create-configuration-items-for-ios-and-mac-os-x-devices-managed-with-intune"></a>Intune을 사용하여 관리되는 iOS 및 Mac OS X 장치에 대한 구성 항목을 만드는 방법
...
8.  **장치 설정** 페이지에서 구성하려는 설정 그룹을 선택합니다. 자세한 내용은 이 항목에서 [iOS 및 Mac OS X 구성 항목 설정 참조](#ios-and-mac-os-x-configuration-item-settings-reference)를 참조하고 **다음**을 클릭합니다.  
