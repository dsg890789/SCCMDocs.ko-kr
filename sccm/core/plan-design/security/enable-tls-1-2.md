...
TLS 1.2를 지원하도록 Configuration Manager를 올바르게 사용하도록 설정하려면 먼저 모든 필수 구성 요소에 대해 TLS 1.2를 사용하도록 설정합니다. 필수 구성 요소는 사용자 환경 및 사용하는 Configuration Manager 기능에 따라 다릅니다.
